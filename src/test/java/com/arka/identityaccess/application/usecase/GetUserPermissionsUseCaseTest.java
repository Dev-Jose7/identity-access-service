...
class GetUserPermissionsUseCaseTest {
    ...
    void shouldReturnEffectiveRolesAndPermissions() {
        ...
        when(userPersistencePort.loadAuthorizationSnapshot(any()))
                .thenReturn(Mono.just(AccessProfile.of(
                        ...
                        Set.of(RoleCode.of("ORG_ADMIN"), RoleCode.of("ORG_USER")),
                        Set.of(PermissionCode.of("iam.user.read"), PermissionCode.of("iam.user.create")),
    ...
    void shouldRejectBlankUserId() {
        ...
        assertThrows(DomainInvariantViolationException.class, () -> useCase.handle(new GetUserPermissionsQuery(" ")));
    }
