...
public class AuthAuditR2dbcRepositoryAdapter implements SecurityAuditPort {
    ...
    @Override
    public Mono<Void> recordUserRegistered(UserAggregate user) {
    ...
    @Override
    public Mono<Void> recordSessionsRevokedByUser(String actorUserId, String targetUserId, String reason, long revokedSessions) {
        return insert(authAuditRowMapper.toSessionsRevokedByUserRow(actorUserId, targetUserId, reason, revokedSessions));
    }
