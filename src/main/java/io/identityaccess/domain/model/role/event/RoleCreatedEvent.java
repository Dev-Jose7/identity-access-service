...
public record RoleCreatedEvent(
    ...
    public static RoleCreatedEvent create(String roleId, String roleCode, String actorUserId, Instant occurredAt) {
        return new RoleCreatedEvent(UUID.randomUUID().toString(), occurredAt, roleId, normalizeRole(roleCode), normalize(actorUserId));
    }
    ...
    @Override public String eventType() { return "RoleCreated"; }
