...
public record PermissionGrantedToRoleEvent(
    ...
    public static PermissionGrantedToRoleEvent create(String roleId, String permissionCode, String actorUserId, Instant occurredAt) {
        return new PermissionGrantedToRoleEvent(UUID.randomUUID().toString(), occurredAt, roleId, normalizeCode(permissionCode), normalize(actorUserId));
    }
    ...
    @Override public String eventType() { return "PermissionGrantedToRole"; }
