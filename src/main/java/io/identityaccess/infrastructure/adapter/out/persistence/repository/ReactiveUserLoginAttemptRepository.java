...
public interface ReactiveUserLoginAttemptRepository extends ReactiveCrudRepository<UserLoginAttemptRow, String> {
    ...
    @Modifying
    @Query("""
            INSERT INTO user_login_attempt (attempt_id, user_id, ip_address, success, attempt_at, created_at)
            VALUES (:attemptId, :userId, :ipAddress, :success, :attemptAt, :createdAt)
            """)
    Mono<Integer> insert(
